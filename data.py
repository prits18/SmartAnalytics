...
filtered_data2 = parties_df[parties_df['EFFECTED_AREA'] == selected_option2]
...
fig.update_layout(barmode='relative', title=f'Positive and Negative Impacts for {selected_option2} area')
st.plotly_chart(fig)